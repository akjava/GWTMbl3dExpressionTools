 ...
 * must be same key
 */
public static NumberKeyframeTrack toTrack(int index,List<AnimationKeyFrame> frames,double modifyValue){
	...
	for(AnimationKeyFrame frame:frames){
		...
		values.push(toModifyValue(trackName,frame.getValue(),modifyValue));
	}
